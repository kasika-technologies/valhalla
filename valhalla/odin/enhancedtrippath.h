...
protected:
  ...
  GetTravelModeTraversability(const TravelMode travel_mode) const;
...
public:
  ...
  bool has_admin_index() const {
    return mutable_node_->optional_admin_index_case() == TripLeg_Node::kAdminIndex;
  }
  ...
  bool HasTraversableExcludeUseXEdge(const TravelMode travel_mode,
